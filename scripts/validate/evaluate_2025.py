...
from scripts._of_validation import POSITIONS, compute_model_oaa, load_of_model, normalize_name
...
def main():
    ...
    real = pd.read_csv(Path(__file__).resolve().parent.parent.parent.parent
