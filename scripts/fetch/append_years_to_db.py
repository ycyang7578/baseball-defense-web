...
Usage:
    python -m scripts.fetch.append_years_to_db 2017 2018 2019
    python -m scripts.fetch.append_years_to_db --positioning-only 2017 2018 2019
"""
import sys
...
from scripts._pg_load import copy_dataframe as _copy
from scripts._pg_load import dedupe_positioning
