...
from scripts._savant_leaderboard import BASE_URL, HEADERS, fetch_leaderboard_raw

OUTPUT_DIR = Path(__file__).resolve().parent.parent.parent / "data" / "raw" / "savant_fielding"
